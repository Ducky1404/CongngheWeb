...
<div class="container mt-5">
    ...
    <a href="<?= DOMAIN . '/index.php?controller=home&action=index'; ?>" class="btn btn-primary mb-3">Home</a>
    <a href="<?= DOMAIN . '/index.php?controller=home&action=logout'; ?>" class="btn btn-danger mb-3">Logout</a>
